...
const PUSH_MESSAGES: Record<string, { title: string; body: string }> = {
  ...
  mailbox_written: { title: '💌 树洞信箱', body: '{name} 在树洞信箱写了一封信，将于周日 14:00 揭晓' },
  mailbox_countdown_24h: { title: '💌 树洞信箱', body: '还有 24 小时就要揭晓本周的信啦，快写点什么给 ta～' },
  mailbox_countdown_15min: { title: '💌 树洞信箱', body: '15 分钟后揭晓本周的信！' },
